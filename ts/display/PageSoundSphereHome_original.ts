class PageSoundSphereHome_original[] extends SimplePage {
  ...
  disableMenuDescriptiveIcon() {
    ...
    removeClassFromElements(
      ".itemMenuDescriptiveIcon.itemMenuDescriptiveIconSelected",
  ...
  setSettingsActions_old(): void {
    ...
    // });
    const buttonVoiceComand = document.getElementById(
      "buttonVoiceComand"
    ...
    document
      .getElementById("confirmRestartPanel")
    ...
    document
      .getElementById("buttonDownloadWav")
      ?.addEventListener("click", () => {
    ...
    document
      .getElementById("buttonCancelarDownload")
      ?.addEventListener("click", () => {
        // this.closeModalDownload();
      });
    // document
    ...
    document
      .getElementById("buttonInitialUploadWav")
      ?.addEventListener("click", () => {
        this.sequenciador.stop(function () {});
        document.getElementById("filesWav")!.click();
    ...
    document
      .getElementById("buttonJson1Cancelar")
      ?.addEventListener("click", () => {
        this.closeModalJson1();
        this.backToMainModal();
      });
    document
      .getElementById("buttonJson2Cancelar")
      ?.addEventListener("click", () => {
    ...
    document
      .getElementById("buttonJson1SelctJson")
      ?.addEventListener("click", () => {
        document.getElementById("fileJSON")!.click();
      });

    document
      .getElementById("buttonJson2SelctWav")
      ?.addEventListener("click", () => {
        document.getElementById("fileHomeWav")!.click();
      });
    document.getElementById("buttonJson3ok")?.addEventListener("click", () => {
      this.closeModalJson3();
      this.reloadAlbum();
      this.painel.reMake();
    });
    document.getElementById("buttonJson4ok")?.addEventListener("click", () => {
      this.closeModalJson4();
      document.getElementById("filesWav")!.click();
    });
    document
      .getElementById("buttonInitialContinue")
      ?.addEventListener("click", () => {
        this.showModalJson1();
      });
  ...
  atualizaTitulo(): void {
    ...
    document.getElementById(
      "valuetitulo"
    )!.innerHTML = `${this.soundSphereInfo.getFullName()} ${
      this.sessionControl.getLastEventNameValid() != undefined
        ? " - " + this.sessionControl.getLastEventNameValid()
        : ""
    }`;
