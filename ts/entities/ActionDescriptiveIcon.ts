...
function generatorActionDescriptiveIcon() {
  ...
  listDescriptiveIcons.push(
    new ActionDescriptiveIcon(
      1,
  ...
  listDescriptiveIcons.push(
    new ActionDescriptiveIcon(3, "img/icons/agua.png", "Agua", "agua")
  );
  listDescriptiveIcons.push(
    new ActionDescriptiveIcon(
      4,
  ...
  listDescriptiveIcons.push(
    new ActionDescriptiveIcon(5, "img/icons/cafe.png", "Café", "cafe")
  );
  listDescriptiveIcons.push(
    new ActionDescriptiveIcon(
      6,
  ...
  listDescriptiveIcons.push(
    new ActionDescriptiveIcon(7, "img/icons/laranja.png", "Laranja", "laranja")
  );
  listDescriptiveIcons.push(
    new ActionDescriptiveIcon(
      8,
  ...
  listDescriptiveIcons.push(
    new ActionDescriptiveIcon(9, "img/icons/limao.png", "Limão", "limao")
  );
  listDescriptiveIcons.push(
    new ActionDescriptiveIcon(
      10,
  ...
  listDescriptiveIcons.push(
    new ActionDescriptiveIcon(10, "img/icons/maca.png", "Maçã", "maca")
  );
  listDescriptiveIcons.push(
    new ActionDescriptiveIcon(
      11,
  ...
  listDescriptiveIcons.push(
    new ActionDescriptiveIcon(12, "img/icons/tomate.png", "Tomate", "tomate")
  );
  listDescriptiveIcons.push(
    new ActionDescriptiveIcon(
      13,
