...
class PageSoundSphereHome_original {
}
[];
SimplePage;
{
    ...
    //pauseActived = false
    itemMixOption: ItemMixPanel | undefined;
    undefined;
    itemOptionEnabled: boolean = true;
    voiceCommandMenuBar ?  : VoiceCommand;
    voiceCommandModalOptions ?  : VoiceCommand;
    idSelectedIcomAlbum: number | undefined;
    undefined;
    mouseInsideIconAlbum: number | undefined;
    undefined;
    ...
    constructor(containerElement, HTMLElement | null, titulo, string, soundSphereInfo, SoundSphereInfo, dao, DAO, sequenciador, Sequenciador, tooltip, Tooltip, sessionControl, SessionControl, pixelpersecond, any);
    {
    ...
    getImgDescriptiveIcon(tag, string);
    string;
    {
    ...
    void {
        ...
        //   this.showModalRestartPanel();
        // });
        document, : (_a = .getElementById("restartPanel")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", () => {
            // this.showModalRestartPanel();
        }),
        // document.getElementById("buttonDownload")?.addEventListener("click", () => {
        //   this.showModalDownloads();
        // });
        document, : (_b = .getElementById("buttonDownload")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", () => {
            // this.showModalDownloads();
        }),
        ...
        //   }
        // });
        document, : (_c = .getElementById("buttonRemove")) === null || _c === void 0 ? void 0 : _c.addEventListener("click", () => {
            this.buttonRemoveStatus = !this.buttonRemoveStatus;
            //Para a mixagem caso esteja executando
            this.stopTrash();
            //Remove a seleção dos demais botões
        ...
        document, : (_d = .getElementById("buttonLoop")) === null || _d === void 0 ? void 0 : _d.addEventListener("click", () => {
            this.sequenciador.changeLoop();
            document.getElementById("buttonLoop").classList.toggle("active");
        }),
        document, : (_e = .getElementById("buttonPlay")) === null || _e === void 0 ? void 0 : _e.addEventListener("click", () => {
            this.playMixagem();
        }),
        document, : (_f = .getElementById("buttonPause")) === null || _f === void 0 ? void 0 : _f.addEventListener("click", () => {
            this.pauseMixagem();
        }),
        document, : (_g = .getElementById("buttonStop")) === null || _g === void 0 ? void 0 : _g.addEventListener("click", () => {
            this.stopMixagem();
        }),
        document, : (_h = .getElementById("cancelModal")) === null || _h === void 0 ? void 0 : _h.addEventListener("click", () => {
            $(".ui.modal").modal("hide");
        }),
        document,
        : (_j = 
        ...
        document, : (_t = .getElementById("buttonJson3ok")) === null || _t === void 0 ? void 0 : _t.addEventListener("click", () => {
            this.closeModalJson3();
            this.reloadAlbum();
            this.painel.reMake();
        }),
        document, : (_u = .getElementById("buttonJson4ok")) === null || _u === void 0 ? void 0 : _u.addEventListener("click", () => {
    ...
    void {
        document,
        : (_w = 
            .getElementById("buttonInitialUploadWav")) === null || _w === void 0 ? void 0 : _w.addEventListener("click", () => {
            this.sequenciador.stop(function () { });
            document.getElementById("filesWav").click();
            this.closeModalInitial();
        })
    ...
    showMessageJson2(mensagemPrincipal, string, listaRequire, any);
    void {
